...
<?php
if (sizeof($posts) == 0) {
    UIUtils::infoBox(L::dashboard_no_likes, L::string_nothing_found);
} else {
...
?>
    <?php 		
    if (sizeof($posts) == 25) {
        echo  '<a class="btn btn-primary float-right" href="https://'.$_ENV['SITE_URL'].'/liked/' . $nextPage . '">'.L::string_next.'</a>'; 
    }
    ?>
</div>
