...
<?php if ($failed == true) {
    UIUtils::errorBox(L::error_page_not_on_blog);
} else { ?>
<div class="col">
...
<input type="text" name="pageTitle" id="pageTitle" class="form-control" placeholder="<?php echo L::post_title_placeholder; ?>" value="<?php echo $page->pageTitle; ?>">
...
<div class="row">
<div class="col">
<button type="submit" name="post" class="btn btn-primary" value="post" id="post" form="PostForm"><?php echo L::string_update; ?></button>
