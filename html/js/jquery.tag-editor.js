        ...
        return selector.each(function(){
            ...
            function split_cleanup(input){
                ...
                for (var i=0; i<sub_tags.length; i++) {
                    ...
                    old_tags.push(tag);
                    li.before('<li><div class="tag-editor-spacer">&nbsp;'+o.delimiter[0]+'</div><div class="tag-editor-tag">'+escape(tag)+'</div></li>');
            ...
            for (var i=0; i<tags.length; i++) {
                ...
                if (tag) {
                    if (o.forceLowercase) tag = tag.toLowerCase();
                    tag_list.push(tag);
                    ed.append('<li><div class="tag-editor-spacer">&nbsp;'+o.delimiter[0]+'</div><div class="tag-editor-tag">'+escape(tag)+'</div></li>');
                }
            }
