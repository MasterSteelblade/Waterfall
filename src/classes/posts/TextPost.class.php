...
class TextPost extends Post {
    ...
    public function createNew($postText, $postTitle, $postTags, $onBlog, $additions, $type) {
        ...
        $values = array('text', $this->content, $this->postTitle, $this->database->php_to_postgres($this->getTagIDs($this->tags)), $this->onBlog, $this->postStatus, $this->timestamp->format("Y-m-d H:i:s.u"), $this->database->php_to_postgres($this->inlineImages), $pollID);
